...
////////////////////////////////////////////////////////////////////////////
BSX = 4377;         //Координаты X БСера с плавильней
BSY = 2775;          //Координаты Y БСера с плавильней
BSer = $0002F2F5;   //ID БСера
////////////////////////////////////////////////////////////////////////////
...
ctime : TDateTime;
begin
    newMoveXY(BSX, BSY, True, 0, False);
    repeat         
...
begin
    ...
    until FindCount <= 0;
    SetGlobal('stealth', 'nameID', IntToStr(Self)+','+IntToStr(2));
    wait(1000);
...
begin
    repeat
        ...
        SetGlobal('stealth','nameID',IntToStr(Self)+','+IntToStr(1));      
        wait(5000);
        Sepor;     
    until TurnID = Self;
end;
